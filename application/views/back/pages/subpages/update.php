                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 pr-0">
                                <div class="form-group">
                                    <label class="form-control-label">Nazwa strony w menu: <span class="tx-danger">*</span></label>
                            ...
                            <div class="form-group bd-t-0-force">
                                <label class="form-control-label">Strona:</label>
                            ...
                            <?php if ($value->description != "ommit") : ?>
                                <div class="col-md-12 pr-0">
                                    <div class="form-group bd-t-0-force bd-b-0-force">
                                        <label class="form-control-label">Krótki opis strony:</label>
