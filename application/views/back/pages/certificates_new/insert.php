    ...
    <div class="br-mainpanel">
        ...
        <div class="br-pagebody mg-t-0 pd-x-30">
            ...
            <form class="form-layout form-layout-2" action="<?php echo base_url(); ?>panel/<?php echo $this->uri->segment(2); ?>/action/<?php echo $this->uri->segment(4) . '/' . 'certificates'; ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 pr-0">
                                <div class="form-group">
                                    <label class="form-control-label">Nazwa Certyfikatu: <span class="tx-danger">*</span></label>
                    ...
                    <div class="col-md-4">
                        <div class="col-md-12">
                            <div class="form-group bd-l-0-force">
                                ...
                                <input type="hidden" id="kind" name="kind" value="current">
