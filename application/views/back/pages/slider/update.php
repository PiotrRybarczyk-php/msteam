                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 pr-0">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" value="<?= $value->title; ?>" name="title" required>
                                </div>
                            </div><!-- col-4 -->
                            <div class="col-md-12 pr-0">
                                <div class="form-group">
                                    <label class="form-control-label">Podtytuł: <span class="tx-danger">*</span></label>
                                    <input class="form-control" type="text" value="<?= $value->subtitle; ?>" name="subtitle" required>
                                </div>
                            </div><!-- col-4 -->
                            <div class="col-md-12 pr-0">
                                <div class="form-group bd-t-0-force">
                                    <label class="form-control-label">Przycisk:</label>
                                    <input class="form-control" type="text" value="<?= $value->button; ?>" name="button">
                                </div>
                            </div><!-- col-4 -->
                            <div class="col-md-12 pr-0">
                                <div class="form-group bd-t-0-force">
                                    <label class="form-control-label">Link:</label>
                                    <input class="form-control" type="text" value="<?= $value->link; ?>" name="link">
                                </div>
                            </div><!-- col-4 -->
                        </div> <!-- set -->
                        <div class="row">
