                    ...
                    <div class="box_flex flex_c small_padding">
                        <div class="grid-1" style="max-width:540px;">
                            ...
                            <div class="content_with_padding">
                                <?= textlim($element->description, 400); ?>
                            </div>
                            <div class="box_flex flex_mob_l"><a class="blank" href="<?= base_url('wpis/') . $element->id . '/' . slug($element->title); ?>"><button class="btn_static">czytaj więcej</button></a></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="grid-2 gtab-1 mb-5" style="min-height:504px;max-width:1440px;">
                    <div class="box_flex flex_c small_padding">
                        <div class="grid-1" style="max-width:540px;">
                            ...
                            <div class="box_flex flex_mob"><a class="blank" href="<?= base_url('wpis/') . $element->id . '/' . slug($element->title); ?>"><button class="btn_static">czytaj więcej</button></a></div>
                        </div>
                    </div>
                    <div class="box_flex flex_c" style="min-height:500px;">
                        <div class="work-photo-border">
